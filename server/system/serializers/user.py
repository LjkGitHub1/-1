...
class UserSerializer(BaseModelSerializer):
    class Meta:
        ...
        fields = [
            ...
            'password', 'dept', 'description', 'last_login', 'date_joined', 'roles', 'rules', 'mode_type', 'medical_record_no'
        ]
        ...
        table_fields = [
            ...
            'last_login', 'date_joined', 'roles', 'rules', 'medical_record_no'
        ]
        extra_kwargs = {
            ...
            'medical_record_no': {'required': True, 'validators': [UniqueValidator(queryset=UserInfo.objects.all())]}
        }
