...
class UploadFile(AutoCleanFileMixin, DbAuditModel):
    ...
    file_type = models.CharField(max_length=255, verbose_name=_("文件类型"))
    ...
    description = models.TextField(verbose_name=_("Description"), blank=True, null=True, help_text=_("File description"))
    user = models.ForeignKey(to="system.UserInfo", verbose_name=_("User"), on_delete=models.SET_NULL, blank=True, null=True, related_name="uploaded_files")
